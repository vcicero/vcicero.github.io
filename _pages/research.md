...
Functional distribution of income as a determinant of importing behavior: An empirical analysis (with Gilberto Tadeu Lima), *Structural Change and Economic Dynamics* 65 (2023), 393–405. [Published Version](https://doi.org/10.1016/j.strueco.2023.03.008){: .btn--research} [WP](/files/pdf/research/wp_cicerolima.pdf){: .btn--research} [Online Appendix](/files/pdf/research/oappendix_cicerolima.pdf){: .btn--research}
...
Trade Liberalization and Mortality Rates: Evidence of Pro-Cyclical Mortality from Brazil (with Lucas Dias and Sammy Zahran) [PDF](/files/pdf/research/cdz_wp.pdf){: .btn--research} 
...
Fiscal Consolidation, Crowding Out, and the Social Safety Net: Evidence from the Budget Control Act of 2011 (with Tim Komarek)

Institutional changes, aggregate demand, income shares and wealth distribution: a model of secular stagnation (with Daniele Tavani)

Illegal markets, resource exploitation, and working conditions: evidence from mahogany trade in the Brazilian Amazon (with Lucas Dias)
