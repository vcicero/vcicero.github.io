...
Resource boom, export composition, concentration, and sophistication: evidence from Brazilian local economies. Job Market Paper [PDF](/files/pdf/research/RB_JMP_Cicero_draft.pdf){: .btn--research}

> This paper investigates the impact of resource booms on regional export baskets in a resource-rich developing country, with a focus on export value, concentration, composition, and sophistication. Using a shift-share instrument that leverages heterogeneous exposure to Chinese demand following China’s WTO accession in 2001, I examine the causal effects of this resource boom on export baskets and sectoral employment in Brazilian local economies. The findings indicate that regions most affected by the demand surge saw increases in export values and a pronounced concentration within a narrow range of products, driven entirely by the resource basket. I document a shift toward primary products over resource-based manufactures, alongside a significant decline in export sophistication in the most exposed regions, without an accompanying reduction in the share of manufacturing exports. Despite boosting wages in the primary and service sectors, this structural shift did not increase employment in the primary sector and led to a relative contraction in manufacturing jobs, reflecting a Dutch disease pattern. These findings underscore the dual-edged impact of resource booms, where short-term gains in export value may be offset by long-term challenges to economic development.
